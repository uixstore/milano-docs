---
title: Blog Overview
description: Learn the basics of managing blog posts in WordPress and how Milano extends the blog experience.
sidebar:
  order: 1
  label: Overview
---
...
For more detail, see the WordPress documentation on [Posts vs Pages](https://wordpress.org/documentation/article/posts-vs-pages/).
...
[WordPress documentation: Add New Post](https://wordpress.org/documentation/article/posts-screen/)
...
[WordPress documentation: Categories vs Tags](https://wordpress.org/documentation/article/categories-vs-tags/)
...
[WordPress documentation: Reading Settings](https://wordpress.org/documentation/article/reading-settings/)
