---
title: Import Demo
description: Browse Milano's pre-built demos and import the one you want with a single click.
sidebar:
  order: 1
---
...
- **You want a working site fast.** Import a demo, replace the text and images, and go live.
- **You want to see what Milano can do.** Demos show the full range of layouts and features.
- **You are starting from scratch.** Demos give you a solid foundation to build on.

If you prefer to build page by page, skip the demo import and start with the [Customizer overview](../customizer/customizer-overview/).

## In this section

- [Import a demo](./import-a-demo/) — step-by-step guide to importing a demo with Milano's built-in importer.
